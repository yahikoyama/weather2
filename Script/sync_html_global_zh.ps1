# ==================================================
# sync_html_global_zh.ps1
# 中国語版HTML生成 + GitHubアップロード（完全版）
# ==================================================

$DictFile = "C:\weather\config\dictionary_zh.json"
...
$OutputFile = "C:\Users\winserverroot\OneDrive\weather_report_now_zh.html"
...
Write-Host "中国語翻訳中..." -ForegroundColor Cyan
...
# ==================================================
# 5. <title> の「レポート」を中国語へ
# ==================================================
$HtmlContent = $HtmlContent.Replace("レポート", "报告")
...
if (-not (Test-Path $OutputFile)) {
    Write-Error "中国語版HTMLが保存されていません。: $OutputFile"
    exit 1
}

Write-Host "中国語版HTMLをローカル保存しました。" -ForegroundColor Green
...
$GitUrl = "https://api.github.com/repos/$Repo/contents/weather_report_now_zh.html"
...
$Body = @{
    message = "Update weather_report_now_zh.html"
...
Write-Host "中国語版処理 完了！" -ForegroundColor Green
