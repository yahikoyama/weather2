# ==================================================
# sync_html_global_ar.ps1
# アラビア語版HTML生成 + GitHubアップロード（完全版）
# ==================================================

$DictFile = "C:\weather\config\dictionary_ar.json"
...
$OutputFile = "C:\Users\winserverroot\OneDrive\weather_report_now_ar.html"
...
Write-Host "アラビア語翻訳中..." -ForegroundColor Cyan
...
# -----------------------------
# <title> の「レポート」をアラビア語へ
# -----------------------------
$HtmlContent = $HtmlContent.Replace("レポート", "?????")
...
if (-not (Test-Path $OutputFile)) {
    Write-Error "アラビア語版HTMLが保存されていません。: $OutputFile"
    exit 1
}

Write-Host "アラビア語版HTMLをローカル保存しました。" -ForegroundColor Green
...
$GitUrl = "https://api.github.com/repos/$Repo/contents/weather_report_now_ar.html"
...
$Body = @{
    message = "Update weather_report_now_ar.html"
...
Write-Host "アラビア語版処理 完了！" -ForegroundColor Green
