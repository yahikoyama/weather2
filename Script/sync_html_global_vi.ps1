# ==================================================
# sync_html_global_vi.ps1
# ベトナム語版HTML生成 + GitHubアップロード（完全版）
# ==================================================

$DictFile = "C:\weather\config\dictionary_vi.json"
...
$OutputFile = "C:\Users\winserverroot\OneDrive\weather_report_now_vi.html"
...
Write-Host "ベトナム語翻訳中..." -ForegroundColor Cyan
...
# -----------------------------
# <title> の「レポート」をベトナム語へ
# -----------------------------
$HtmlContent = $HtmlContent.Replace("レポート", "Báo cáo")
...
if (-not (Test-Path $OutputFile)) {
    Write-Error "ベトナム語版HTMLが保存されていません。: $OutputFile"
    exit 1
}

Write-Host "ベトナム語版HTMLをローカル保存しました。" -ForegroundColor Green
...
$GitUrl = "https://api.github.com/repos/$Repo/contents/weather_report_now_vi.html"
...
$Body = @{
    message = "Update weather_report_now_vi.html"
...
Write-Host "ベトナム語版処理 完了！" -ForegroundColor Green
